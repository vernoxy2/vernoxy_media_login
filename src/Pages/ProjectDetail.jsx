...
//                   project.websiteDesign.link.some(
//                     (link) => link && link.trim() !== "",
//                   ) && (
//                     <div className="mt-4 text-start">
...
//                             target="_blank"
//                             rel="noopener noreferrer"
//                             className="block text-sm text-blue-600 dark:text-blue-400 underline mb-1 hover:text-blue-800 dark:hover:text-blue-300"
//                           >
//                             {link}
//                           </a>
//                         ))}
...
//                   <p className="font-medium text-foreground">
//                     {project.websiteDesign.pages[0].pageName || "Not specified"}
//                   </p>
//                 </div>
//                 <div>
//                   <p className="text-sm text-muted-foreground">Page Purpose</p>
//                   <p className="font-medium text-foreground">
//                     {project.websiteDesign.pages[0].pagePurpose || "Not specified"}
//                   </p>
//                 </div>
//                  <div>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {project.serviceType === "WD" && project.websiteDesign && (
            <div className="rounded-xl border border-service-website/20 bg-service-website/5 p-6 text-start">
              ...
              {/* Page-wise Structure Section */}
              <div className="mt-6">
                <h3 className="text-md font-semibold text-foreground mb-4">
                  Page-wise Structure
                </h3>
                <div className="space-y-4">
                  {project.websiteDesign.pages?.map((page, pageIndex) => (
                    <div
                      key={pageIndex}
                      className="border-2 border-service-website/30 rounded-lg p-4 bg-background/50 hover:bg-background/70 transition-colors"
                    >
                      {/* Page Header */}
                      ...
                      {page.sections && page.sections.length > 0 && (
                        <div className="mt-4 space-y-3">
                          ...
                          {page.sections.map((section, sectionIndex) => (
                            <div
                              key={sectionIndex}
                              className="border-l-4 border-service-website pl-4 py-3 bg-muted/40 rounded-r-md hover:bg-muted/60 transition-colors"
                            >
                              <div className="flex items-start gap-3">
                                <Badge
                                  variant="secondary"
                                ...
                                <div className="flex-1 space-y-2">
                                  {section.mainHeading && (
                                    <div>
                                      <p className="text-xs text-muted-foreground">Main Heading:</p>
                                  ...
                                  {section.subHeading && (
                                    <div>
                                      <p className="text-xs text-muted-foreground">Sub Heading:</p>
                                  ...
                                  {section.buttonLink && (
                                    <div>
                                      <p className="text-xs text-muted-foreground">Button Link:</p>
                                      <a
                                        href={section.buttonLink.startsWith('http') ? section.buttonLink : `https://${section.buttonLink}`}
                                        target="_blank"
                                        rel="noopener noreferrer"
                                  ...
                                  {section.layoutNotes && (
                                    <div>
                                      <p className="text-xs text-muted-foreground">Layout Notes:</p>
                                      <p className="text-xs text-foreground">
                                        {section.layoutNotes}
                                      </p>
                                    </div>
