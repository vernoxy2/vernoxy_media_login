      ...
      <div className="grid gap-8 lg:grid-cols-3">
        <div className="lg:col-span-2 space-y-6">
          ...
          {project.serviceType === "ERP" && project.erp && (
            <div className="rounded-xl border border-service-erp/20 bg-service-erp/5 p-6 text-start space-x-5 space-y-5">
              <h2 className="mb-4 flex items-center gap-2 text-lg font-semibold text-foreground">
              ...
              <div className="grid gap-4 ">
                ...
                <p className="font-medium text-foreground">
                  {project.erp.workflowDescription || "None"}
                </p>
              </div>
              <div className="grid gap-4 ">
                <p className="text-sm text-muted-foreground">
              ...
              <div className="grid gap-4 ">
                ...
                <p className="font-medium text-foreground">
                  {project.erp.technicalNotes || "None"}
                </p>
              </div>
            </div>
          )}
